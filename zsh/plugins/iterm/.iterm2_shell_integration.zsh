...
alias imgcat=${0:A:h}/.iterm2/imgcat;alias imgls=${0:A:h}/.iterm2/imgls;alias it2api=${0:A:h}/.iterm2/it2api;alias it2attention=${0:A:h}/.iterm2/it2attention;alias it2check=${0:A:h}/.iterm2/it2check;alias it2copy=${0:A:h}/.iterm2/it2copy;alias it2dl=${0:A:h}/.iterm2/it2dl;alias it2getvar=${0:A:h}/.iterm2/it2getvar;alias it2git=${0:A:h}/.iterm2/it2git;alias it2setcolor=${0:A:h}/.iterm2/it2setcolor;alias it2setkeylabel=${0:A:h}/.iterm2/it2setkeylabel;alias it2tip=${0:A:h}/.iterm2/it2tip;alias it2ul=${0:A:h}/.iterm2/it2ul;alias it2universion=${0:A:h}/.iterm2/it2universion;alias it2profile=${0:A:h}/.iterm2/it2profile;alias it2cat=${0:A:h}/.iterm2/it2cat
